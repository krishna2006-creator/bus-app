...
/// College-themed colors for bus tracking system
class AppColors {
  // Role-specific primary colors
  static const adminBlue = Color(0xFF2563EB);
  static const studentGreen = Color(0xFF10B981);
  static const staffOrange = Color(0xFFF97316);
  static const driverRed = Color(0xFFEF4444);
...
class LightModeColors {
  // Primary: Soft blue for a modern, professional look
  static const lightPrimary = Color(0xFF2563EB);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFDCE9FF);
